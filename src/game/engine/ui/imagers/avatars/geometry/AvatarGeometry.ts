...
export class AvatarGeometry extends Geometry {
    ...
    constructor(geometry: IGeometry) {
        ...
        if (geometry.camera) {
            this.cameraPoint.x = geometry.camera.x;
            this.cameraPoint.y = geometry.camera.y;
            this.cameraPoint.z = geometry.camera.z;
        }
    ...
    hasBodyPart(type: string, id: string): boolean {
