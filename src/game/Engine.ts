...
export class Engine {
    ...
    public async init(): Promise<void> {
        ...
        if (this._config.offlineMode) {
            let room: Room = this._roomsService.setRoom("prova", `0000000000000000/0222222222222222/2222222222222222/0222111111111111/0222111111111111/0222111111111111/0222111111111111/0222111111111111/`,
             new Point(2,0), 200)
